...
create table if not exists `heroclash4geeks`.`characterItems` (
    ...
    CONSTRAINT `fk_characterItem_character` FOREIGN KEY (`characterId`) REFERENCES `heroclash4geeks`.`characters` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
);
insert into heroclash4geeks.characters
values(1, 'Anakin Skywalker', 'Fallen Jedi', 11, 101, 11, 22);
insert into heroclash4geeks.characterItems
values(1, 'Lightsaber');
insert into heroclash4geeks.characterItems
values(1, 'Death Star');